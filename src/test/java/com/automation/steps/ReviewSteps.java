...
public class ReviewSteps {
    ...
    public void verifyTotalPriceIsEqualToSumOfPricesOfItemsAddedAndTheTax() {
        reviewPage.givesSumOfPrices();
        Assert.assertEquals(reviewPage.givesTotalAmount(),reviewPage.givesSumOfPricesAndTax());
    }
}
